...
export const YOUR_ONGOING_ORDERS = 'Your ongoing orders';
...
export const DRY_CLEAN = 'Dry Clean';
export const STEAM_IRON = 'Steam Iron';
export const SHOE_CLEAN = 'Shoe Clean';
